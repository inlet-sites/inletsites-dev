...
<div class="container">
    ...
    <p>After a website has been created, you will also need to host it on a server to open it up to the internet. Inlet Sites can handle all of the hosting for the website so that you never have to worry about anything. Pricing for the hosting is paid monthly and is based on the complexity of the site that you need hosted.</p>

    <p>Unfortunately, we cannot host sites created by other developers. The reason for this is the technical challenges in doing so. There are many different coding languages, frameworks, etc. that other developers may have used and we cannot guarantee time, price or quality of sites not developed here at Inlet Sites.</p>

    <p>However, if you would like to take your site developed at Inlet Sites to another developer/hosting service, then you may do so at any time with no cancellation fees.</p>
